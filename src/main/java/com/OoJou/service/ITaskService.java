...
public interface ITaskService {
	...
	ServerResponse<PageInfo> getTaskOfUser(String username,int pageNum,int pageSize,String sortType);
	ServerResponse<PageInfo> getTaskOfUserCreate(String username,int pageNum,int pageSize,String sortType);
	ServerResponse<PageInfo> getTaskOfUserClose(String username,int pageNum,int pageSize,String sortType);
	ServerResponse<PageInfo> getTaskOfUserNow(String username,int pageNum,int pageSize,String sortType);
