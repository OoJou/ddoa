...
var save_question;
var save_token;
//以下内容，复制到eclipse中，href的路径需要修改成对于的controller方法定义的路径
...
function forget_answer_html(result) {
    ...
    var question=$("<li class='question'></li>").append("<p>问题："+result.data+"</p>");
    var question2=$("<li class='question'><p>问题：</p></li>").append(result.data);
    var question3=$("<li class='question'><p th:text=${result.data}></p></li>");
    var answer = $(
        "                <li class=\"item\">" +
